...
ARGS="-m $DEFAULT_MODEL -c 262144 -ngl 99 -ctk q4_0 -ctv q4_0 --host 127.0.0.1 --port 11440 --slot-save-path /home/flip/llama_slots"
...
/home/flip/llama.cpp/build/bin/llama-server $ARGS
