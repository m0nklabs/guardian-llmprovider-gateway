...
**STAP 8 — pending (last step):** 3 live loads on `:11440` (`LD_LIBRARY_PATH=/usr/local/cuda-12.8/lib64`):
...
3. Qwen3.6 + turbo4 (runtime override via allowed_kv_types). Append results here.
