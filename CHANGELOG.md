...
### Changed
- Fixed the Huihui Gemma4 26B A4B runtime metadata to use the real `ngl: 30` layer count, added short `gemma4-q8kv` / `gemma4-quality` aliases, and tuned its full-context `q8_0/q8_0` production split to `0.36,0.64` after a Guardian-backed sweep showed the best combined headroom and smoke latency on this host.
